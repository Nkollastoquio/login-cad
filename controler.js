...
function excluir(i){
    // comentario sobre o splice :altera o conteúdo de uma lista, adicionando novos elementos enquanto remove elementos antigos.
    dadosLista.splice((i-1),1);
    document.getElementById('tabela').deleteRow(i); // I deleteRow é um blalba método remove uma linha específica ( <tr>) de um dado
    document.getElementById('nomeUser'). value = "";
}
